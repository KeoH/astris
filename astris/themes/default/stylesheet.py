...
stylesheet.add_class(
    ...
    style=Style(
        ...
        background_color="rgba(246, 248, 252, 0.85)",
        border_bottom="1px solid rgba(216, 224, 235, 0.9)",
    ),
)
...
body {
  ...
  color: var(--color-text);
  background: radial-gradient(circle at 10% 20%, #f7f9fd, #e8edf6 70%);
  line-height: 1.5;
}
...
# 3) Selectores con combinadores (más cómodo en raw)
stylesheet.add_raw(
    """
...
stylesheet.add_class("btn-primary", Style(
    background="linear-gradient(145deg, #1c63d1, #1558bc)",
    border_color="#1558bc",
    color="#fff",
))

stylesheet.add_class("btn-primary:hover", Style(
    background="linear-gradient(145deg, #1858bc, #124ea7)"
))
...
stylesheet.add_class("btn-danger", Style(
    background="linear-gradient(145deg, #b3362f, #972922)",
    border_color="#972922",
    color="#fff",
))
